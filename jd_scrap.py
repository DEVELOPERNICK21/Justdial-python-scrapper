...
# -----> Type the name of your excel or csv file.
out_file = open('Rajgarh_Biometric.csv', 'w')
csvwriter = csv.DictWriter(out_file, delimiter=',', fieldnames=fields)

# Write fields firstṇṇ
#csvwriter.writerow(dict((fn,fn) for fn in fields))
while True:
    # Check if reached end of result
    if page_number > 50:
        break
# enter the url by removing the number from page-2 to page-
    url = "https://www.justdial.com/Rajgarh/Biometric-Attendance-Recording-System-Dealers/nct-10932847/page-%s" % (
        page_number)
    print(url)
